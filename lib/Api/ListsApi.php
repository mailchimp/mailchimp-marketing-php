...
class ListsApi
{
    ...
    public function previewSegment($list_id, $body)
    {
        $response = $this->previewSegmentWithHttpInfo($list_id, $body);
        return $response;
    }

    public function previewSegmentWithHttpInfo($list_id, $body)
    {
    ...
    protected function previewSegmentRequest($list_id, $body)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
