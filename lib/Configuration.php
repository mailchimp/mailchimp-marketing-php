...
use MailchimpMarketing\Api\DashboardApi;
use MailchimpMarketing\Api\EcommerceApi;
use MailchimpMarketing\Api\ExternalAuthsApi;
...
use MailchimpMarketing\Api\PostcardsApi;
...
class ApiClient
{
    ...
    protected $userAgent = 'Swagger-Codegen/3.0.13/php';
    ...
    public function __construct()
    {
        ...
        $this->externalAuths = new ExternalAuthsApi($this);
        ...
        $this->postcards = new PostcardsApi($this);
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    OpenAPI Spec Version: 3.0.13' . PHP_EOL;
        $report .= '    SDK Package Version: 3.0.13' . PHP_EOL;
