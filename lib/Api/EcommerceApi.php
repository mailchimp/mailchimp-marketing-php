...
class EcommerceApi
{
    ...
    {
        $response = $this->infoWithHttpInfo();
        return $response;
    }
    ...
    public function getAllStoreProducts($store_id, $fields = null, $exclude_fields = null, $sort_field = null, $count = '10', $offset = '0')
    {
        $response = $this->getAllStoreProductsWithHttpInfo($store_id, $fields, $exclude_fields, $sort_field, $count, $offset);
        return $response;
    }

    public function getAllStoreProductsWithHttpInfo($store_id, $fields = null, $exclude_fields = null, $sort_field = null, $count = '10', $offset = '0')
    {
        $request = $this->getAllStoreProductsRequest($store_id, $fields, $exclude_fields, $sort_field, $count, $offset);
    ...
    protected function getAllStoreProductsRequest($store_id, $fields = null, $exclude_fields = null, $sort_field = null, $count = '10', $offset = '0')
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
